            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    <div style="width: 200px;height: 100px;display: flex;justify-self:center;">
                        <img alt="Content image" v-bind:src="imageFullPath" />
                    </div>
                    <h2 class="text-base leading-relaxed text-gray-500 dark:text-gray-400"
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-6 space-y-6">
                                    <form action="get">
                                        ...
                                        <div>
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="file_input">change title</label>
                                            <input v-model="title"
                                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                                id="file_input" type="text">

                                        </div>
                                        <div>
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="file_input">change content</label>
                    ...
                    <button @click="deleteDate" data-modal-hide="staticModal" type="button"
